            ...
            <div className="flex md:flex-row flex-col items-center justify-center">
              <div className="md:w-1/2 w-full space-y-6">
                <h1 className="md:text-5xl text-5xl text-white font-semibold">
                  We are building the most friendly DEX exchange with UtoSwap
                </h1>
                <p className="text-white mb-4 md:mb-0">
                  UtoSwap is a DEX exchange for Utopos token holders. It will
                  also support cross-chain trading with other blockchains such
                  as ETH, BTC, EOS and etc. We aim to build the most friendly
                  and secure exchange with lowest fees that can be used by
                  regular people.
                </p>
              </div>
